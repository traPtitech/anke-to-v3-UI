...
export type GatewayQuestionText = QuestionBase &
  components['schemas']['QuestionSettingsText'];
export type GatewayQuestionTextLong = QuestionBase &
  components['schemas']['QuestionSettingsTextLong'];
export type GatewayQuestionNumber = QuestionBase &
  components['schemas']['QuestionSettingsNumber'];
export type GatewayQuestionSingleChoice = QuestionBase &
  components['schemas']['QuestionSettingsSingleChoice'];
export type GatewayQuestionMultipleChoice = QuestionBase &
  components['schemas']['QuestionSettingsMultipleChoice'];
export type GatewayQuestionScale = QuestionBase &
