...
import type { ResponseFormQuestionnaireFormSettings } from '~/components/based-response-form/questionnaire-settings';
...
<template>
  <BasedResponseForm :form-settings="formSettings" :send-sentence="sending" />
</template>
